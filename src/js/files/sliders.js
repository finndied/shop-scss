...
function initSliders() {
	...
	if (document.querySelector('.main-block')) { // Указываем скласс нужного слайдера
		// Создаем слайдер
			...
			*/
			...
			on: {
				init: function (swiper) {
					...
					allSlides.innerHTML = allSlidesItems.length < 10 ? `${allSlidesItems.length}` : swiper.slides.length;
				},
